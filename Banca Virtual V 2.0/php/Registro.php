...
<html lang="en">
	...
	$sql="call insertarCliente('".$nombre."','".$apellido."','".$password1."','".$password2."','".$correo."',".$pregunta1.",'".$respuesta1."',".$pregunta2.",'".$respuesta2."','".$userName."');";

	$resultado = mysql_query($sql);
					if (!$resultado) {
						echo '<script language="javascript">alert("El nombre de usuario que usted escogio ya esta registrado");</script>';
					}
					else{
					echo '<script language="javascript">alert("El usuario se creo correctamente");</script>'; 
	...
	<section >
			...
			<div class = "recuperar">
				...
				<form method="post" action="Registro.php" >
					...
					<input name="userName" class = "form-control" type = "text" placeholder="Nombre de Usuario:"required>
					</div>
					</div>
					...
					<div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div>	
					 <input name="password1"  class = "form-control" type = "password" placeholder="Clave " required>
					 </div>
					</div>
					...
					<input name="password2"  class = "form-control" type = "password" placeholder="Clave Internet" required>
					</div>
					</div >
					...
					<div class="form-group ">
						...
						<input name="correo" class = "form-control" type = "text" placeholder="Correo:" required>
					</div>
				    </div>
                               ...
                               <div id="coll" class="panel-collapse collapse">
	                               <div class="panel-body ">
	                                  <div class="form-group ">
										...
										<input name="respuesta1" class = "form-control" type = "text" placeholder="Primera respuesta: "required>
										</div>
								    	</div>
                               ...
                               <div id="coll2" class="panel-collapse collapse">
	                               <div class="panel-body ">
	                                  <div class="form-group ">
										...
										<div class="input-group">
										<div class="input-group-addon "><span class="glyphicon glyphicon-pencil"></span></div>
										<input name="respuesta2" class = "form-control" type = "text" placeholder="Segunda respuesta:"required>
										</div>
								    	</div>
				   ...
				   <CENTER>
					   <input name="botoncito" type = "submit"  class='btn btn-primary' value = "Registrarme" >
					</CENTER>
