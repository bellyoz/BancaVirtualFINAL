...
<html>
	...
	<body onload = "run()">
		...
		$sql = "SELECT * from servicios where idcliente=".$_SESSION['id'].";";
		...
		<section >
			...
			<div class = "recuperar  con animated zoomIn" id="cp">
				<div class="table-responsive">
					  <div class="panel panel-default">
					<div class="panel-heading"><h2>Servicos publicos por pagar<h2></div>
                  ...
                  <tr>
                    ...
                    <tr>                 
						...
						while ($fila = mysql_fetch_assoc($resultado)) {
							echo "<tr>";
							echo "<td>".$fila['idservicios']."</td>";
							echo "<td>".$fila['valor']."</td>";
							echo "<td>".$fila['concepto']."</td>";
							echo "<td>".$fila['fechaLimite']."</td>";
							}
						echo"</tr>";
				        ?>	
  					</tr>
				...
				<center>
                <input type="submit" value="Agregar servicio" class="btn btn-success" onclick="window.location.href='AgregarServicio.php'">
				<input type="submit" value="Pagar servicio" class="btn btn-success" onclick="window.location.href='PagarServicio.php'">
				</center>
			</div>			
		</section>
		<footer >
