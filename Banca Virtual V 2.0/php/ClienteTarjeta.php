...
<html>
	...
	<body onload = "run()">
		...
		$sql = "SELECT * from tarjeta where idcliente=".$_SESSION['id'].";";
			...
			<div class = "recuperar con animated zoomIn">
				<div class="table-responsive">
					  <div class="panel panel-default">
					     <div class="panel-heading"><h2>Informacion de la tarjeta<h2></div>
				...
				<center>
				 <input type="submit" value="Pagos con tarjeta" class="btn btn-success" onclick="window.location.href='PagosTarjeta.php'">	
				</center>
		</div>
		</section>
		<footer >
