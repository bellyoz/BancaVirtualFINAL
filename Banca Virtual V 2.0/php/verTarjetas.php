	...
	?>
		...
		<section >
			<div class = "con animated fadeInDown">
				<form class="formu_crear" action = "verTarjetas.php" method = "post">
					<ul>
						<li  class = "row">
							<label>Tarjeta</label>
							...
							<select name="myselect" id="myselect" onchange="this.form.submit()">
								...
								<?php
								$sql = "SELECT idtarjeta from tarjeta where idcliente=".$_SESSION['usuarioEdit'].";";
					...
					<?php
						...
						$sql3 = "SELECT * from tarjeta where idtarjeta = ".$choice.";";
					...
					echo"
						...
						<li class = 'row'>
							<label>Cupo</label>
							<input  class = 'text' type='text' readonly='readonly' name='text_Saldo' value = '".$fila3['cupo']."'> 
						</li>
						<li class = 'row'>";
						if($fila3['activo'] == 0 ){
						echo "
